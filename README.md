...
Lista de países e população utilizando React Hooks desenvolvidos no bootcamp fullstack da IGTI
...
1. Clonar via prompt de comando o projeto em uma pasta de sua preferência: `git clone https://github.com/cicerorod/igti-fullstack-mod3-react-populacao-de-pais-react-hooks.git`
2. Acessar a pasta principal do projeto via prompt de comando. Ex: `cd igti-fullstack-mod3-react-populacao-de-pais-react-hooks`;
...
1. Faça o _fork_ do projeto (<https://github.com/cicerorod/igti-fullstack-mod3-react-populacao-de-pais-react-hooks/fork>)
...
Este projeto está sob a licença do MIT. Consulte [LICENSE](https://github.com/cicerorod/igti-fullstack-mod3-react-populacao-de-pais-react-hooks/blob/master/LICENSE) para obter mais informações.
